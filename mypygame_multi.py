...
def main():
    ...
    def crash(): 
        ...
        message_display("Enter to play again",140, 185, 0)
    ...
    def level_1():
        ...
        s_hero = Hero(s_hero_image, [350, 400])
        s_hero.move = [pygame.K_a, pygame.K_d, pygame.K_w, pygame.K_s]
        s_hero.vx = 5
        s_hero.vy = 5
        s_heros_group = pygame.sprite.Group()
        s_heros_group.add(s_hero)
        ...
        while not running:
          ...
          #----------------------special hero key-----------------------  
            for i in range(2):  
                if key[s_hero.move[i]]:
                    s_hero.rect.x += s_hero.vx * [-1, 1][i]

            for i in range(2):
                if key[s_hero.move[2:4][i]]:
                    s_hero.rect.y += s_hero.vy * [-1, 1][i]
            ...
            if s_hero.rect.x > width - s_hero_width:
                s_hero.rect.x -= 10
            elif s_hero.rect.x < 0:
                s_hero.rect.x += 10 
            elif s_hero.rect.y < 0: 
                s_hero.rect.y += 10
            elif s_hero.rect.y > height - s_hero_height:
                s_hero.rect.y -= 10           
            #   running = False 
            ...
            s_hit_monsters = pygame.sprite.spritecollide(s_hero, monsters_group, True)
            s_hit_hero = pygame.sprite.spritecollide(s_hero, goblins_group, True)
            if hit_monsters:
                score_count += 1    
                if score_count == 4:
    ...
    s_hero_image = pygame.image.load('images/hero_Fotor.png').convert_alpha()
